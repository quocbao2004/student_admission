...
urlpatterns = [
    ...
    path('admin/methods/', AdminMethodCRUDView.as_view(), name='admin-methods-list'),
    path('admin/methods/<uuid:pk>/', AdminMethodCRUDView.as_view(), name='admin-methods-detail'),
